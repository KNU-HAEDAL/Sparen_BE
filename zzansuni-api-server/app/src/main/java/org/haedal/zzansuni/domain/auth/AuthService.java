...
public class AuthService {
     ...
     */
    public Pair<JwtToken, UserModel.Model> oAuth2LoginOrSignup(OAuth2Provider provider,
        ...
        UserModel.Model userModel = UserModel.Model.from(user);
    ...
    @Transactional
    public Pair<JwtToken, UserModel.Model> signup(UserCommand.Create command) {
    ...
    public Pair<JwtToken, UserModel.Model> login(String email, String password) {
